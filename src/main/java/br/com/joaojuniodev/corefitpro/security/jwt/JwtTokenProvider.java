package br.com.joaojuniodev.corefitpro.security.jwt;
...
public class JwtTokenProvider {
    ...
    public String getAccessToken(String username, Date now, Date validity, List<String> roles) {
    ...
    public String getRefreshToken(String username, Date now, List<String> roles) {
