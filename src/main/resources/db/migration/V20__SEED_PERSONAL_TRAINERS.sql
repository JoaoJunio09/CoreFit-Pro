...
DECLARE
    ...
    patricia_user_id UUID := gen_random_uuid();
BEGIN
    INSERT INTO users (id, username, password, full_name, email, recovery_email, account_non_expired, account_non_locked, credentials_non_expired, enabled) VALUES
        ...
        (patricia_user_id, 'patricia', '{pbkdf2}5983cdc466ee7e15c41069e3585f68fc6ad3e5b65355d2c1c9c2d824d313bc7b3faded4f2cabcaf0', 'Patrícia Almeida', 'patricia@corefitpro.com', 'patricia@corefitpro.com', TRUE, TRUE, TRUE, TRUE);

    INSERT INTO user_role (user_id, role_id)
    SELECT u.id, r.id FROM users u, roles r
    WHERE u.id IN (lucas_user_id, fernanda_user_id, rafael_user_id, patricia_user_id) AND r.name = 'PERSONAL';
    ...
    INSERT INTO personals_trainers (id, first_name, last_name, user_id) VALUES
        ...
        (gen_random_uuid(), 'Patrícia', 'Almeida', patricia_user_id);
END $$;
